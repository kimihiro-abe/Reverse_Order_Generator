...
<img src="https://github.com/kimihiro-abe/Reverse_Order_Generator/blob/main/Reverse_Order_Generator_01.png" width="35%">
<br>
...
その時点の技術で制作したプログラムです。  
<br>
制作してから二か月。 少し振り返ってみますと。  

5月の本訓練開始時に教室が変更になったのですが、  
そちらの教室ではプログラム関連書籍が数多く開架されていました。  
<br>
それらの書籍をパラパラ見ては気になる箇所を、  
チョコチョコ打ち込ちこんで試していて、  
この訓練以外での自習効果が結構あったように思います。  
<br>
<hr>
...
どんなものが出力されるのか？  
参考として以下の画像をご参照ください。  
<img src="https://github.com/kimihiro-abe/Reverse_Order_Generator/blob/main/Reverse_Order_Generator_02.png" width="35%">
